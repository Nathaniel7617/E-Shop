...
const Banner = ({ data, handleOrderPopup }) => {
  return (
    <div className='min-h-[530px] flex justify-center items-center mt-[-5%]'>
      <div className='container'>
        ...
        >
          ...
          {/* second col */}
          <div data-aos="zoom-in" className='flex items-center relative z-10'>
          <img
              src={data.image}
              alt=""
              className='scale-150 w-[250px] 
              md:w-[300px] mx-auto 
              drop-shadow-2xl 
              object-cover '
            />
